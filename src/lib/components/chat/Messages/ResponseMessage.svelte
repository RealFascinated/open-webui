<script lang="ts">
	...
	export let showPreviousMessage: (...args: unknown[]) => unknown;
	export let showNextMessage: (...args: unknown[]) => unknown;
	...
	export const rateMessage: (...args: unknown[]) => unknown = () => {};
	...
	export const addMessages: (...args: unknown[]) => unknown = () => {};
