...
def get_loader(request, url: str, config: dict):
    ...
    return get_web_loader(
        ...
        external_web_loader_url=config.get('external_web_loader_url'),
        external_web_loader_api_key=config.get('external_web_loader_api_key'),
        web_loader_timeout=config.get('web_loader_timeout'),
    )
