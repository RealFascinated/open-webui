...
def build_task_metadata(task: str, form_data: dict) -> dict:
    return {
        'task': str(task),
        'task_body': form_data,
...
async def generate_title(request: Request, form_data: dict, user=Depends(get_verified_user)):
    ...
    payload = {
        ...
        **(
        ...
        'metadata': build_task_metadata(TASKS.TITLE_GENERATION, form_data),
    }

    try:
        return await run_task_completion(request, payload, user, models)
...
async def generate_follow_ups(request: Request, form_data: dict, user=Depends(get_verified_user)):
    ...
    payload = {
        ...
        'messages': [{'role': 'user', 'content': content}],
        'stream': False,
        'metadata': build_task_metadata(TASKS.FOLLOW_UP_GENERATION, form_data),
    }
...
async def generate_chat_tags(request: Request, form_data: dict, user=Depends(get_verified_user)):
    ...
    payload = {
        ...
        'messages': [{'role': 'user', 'content': content}],
        'stream': False,
        'metadata': build_task_metadata(TASKS.TAGS_GENERATION, form_data),
    }
...
async def generate_image_prompt(request: Request, form_data: dict, user=Depends(get_verified_user)):
    ...
    payload = {
        ...
        'messages': [{'role': 'user', 'content': content}],
        'stream': False,
        'metadata': build_task_metadata(TASKS.IMAGE_PROMPT_GENERATION, form_data),
    }
...
async def generate_queries(request: Request, form_data: dict, user=Depends(get_verified_user)):
    ...
    payload = {
        ...
        'messages': [{'role': 'user', 'content': content}],
        'stream': False,
        'metadata': build_task_metadata(TASKS.QUERY_GENERATION, form_data),
    }
...
async def generate_autocompletion(request: Request, form_data: dict, user=Depends(get_verified_user)):
    ...
    payload = {
        ...
        'messages': [{'role': 'user', 'content': content}],
        'stream': False,
        'metadata': build_task_metadata(TASKS.AUTOCOMPLETE_GENERATION, form_data),
    }
...
async def generate_emoji(request: Request, form_data: dict, user=Depends(get_verified_user)):
    ...
    payload = {
        ...
        **(
        ...
        'metadata': build_task_metadata(TASKS.EMOJI_GENERATION, form_data),
    }
...
async def generate_moa_response(request: Request, form_data: dict, user=Depends(get_verified_user)):
    ...
    payload = {
        ...
        'metadata': build_task_metadata(TASKS.MOA_RESPONSE_GENERATION, form_data),
    }
